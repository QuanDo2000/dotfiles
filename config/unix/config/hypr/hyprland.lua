...
bind(mainMod .. " + CTRL + Space", hl.dsp.exec_cmd(app .. "bitwarden-picker"), "Open password vault")
bind(mainMod .. " + F1", hl.dsp.exec_cmd("$HOME/.local/bin/show-keybinds"), "Show keybinds")
