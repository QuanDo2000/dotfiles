...
- [x] Editing extras with explicit prior opt-in: mini.surround and hex-color highlights; native text objects, registers/paste, and `<C-a>`/`<C-x>` cover common editing.
