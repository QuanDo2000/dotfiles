...
test_home_config_owns_remaining_dotfiles() {
  ...
  assert_contains "$home_text" "\".codex/skills/systematic-debugging\" = forceSource \"\${superpowersSrc}/skills/systematic-debugging\""
  assert_contains "$home_text" "\".codex/skills/test-driven-development\" = forceSource \"\${superpowersSrc}/skills/test-driven-development\""
  assert_contains "$home_text" "\".codex/skills/verification-before-completion\" = forceSource \"\${superpowersSrc}/skills/verification-before-completion\""
  assert_not_contains "$home_text" ".codex/skills/brainstorming"
